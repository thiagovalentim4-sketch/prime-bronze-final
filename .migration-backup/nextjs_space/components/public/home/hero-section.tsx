  ...
  return (
    <section className="relative min-h-[85vh] flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-[1200px] mx-auto px-4 text-center">
        ...
        >
          <div className="relative w-28 h-28 md:w-36 md:h-36 rounded-full overflow-hidden ring-2 ring-[#D4AF37]/50">
            <Image src="/images/logo.jpeg" alt="Prime Bronze" fill className="object-cover" />
          </div>
